...
### 3. Hugging Face Spaces (Demo Version)
- Use `huggingface_deployment/requirements.txt`
- App file: `huggingface_deployment/simple_app.py` (demo version without model files)
...
3. **For Hugging Face Deployment (Demo Version)**:
   - `huggingface_deployment/simple_app.py`
   - `huggingface_deployment/requirements.txt`
...
python huggingface_deployment/simple_app.py
```

#!/usr/bin/env python3
"""
AI TraceFinder - Final Integrated Streamlit Application
Combines both Objective 1 (Scanner ID: 93.75%) and Objective 2 (Tampered Detection: 88.41%)
"""
...
class IntegratedTamperedDetector:
    """Integrated Tampered Detection using the trained ensemble model (88.41% accuracy)"""
    ...
    def load_model(self):
        ...
        try:
            ...
            if os.path.exists(self.model_path):
                ...
                print("✅ Loaded tampered detection ensemble model")
            else:
                print(f"❌ Ensemble model not found: {self.model_path}")
                return False
    ...
    def predict_tampered(self, image):
        ...
        try:
            ...
            if hasattr(self.model, 'predict_proba'):
                ...
                confidence = max(proba)  # Use the higher probability as confidence
            else:
...
def main():
    ...
    with col2:
        st.markdown('<div class="accuracy-badge">🛡️ Tampered Detection<br>88.41% Accuracy<br>Ensemble Model</div>', unsafe_allow_html=True)
    with col3:
    ...
    if 'tampered_detector' not in st.session_state:
        st.session_state.tampered_detector = IntegratedTamperedDetector()
    ...
    with st.sidebar:
        ...
        st.markdown("- Tampered detection uses ensemble model")
        ...
        st.markdown("- **Models:** Ensemble learning, voting classifiers")
    ...
    <div style="text-align: center; color: #6c757d; margin-top: 2rem;">
        ...
        <p>Scanner Identification: 93.75% accuracy | Tampered Detection: 88.41% accuracy</p>
